...
fun RecordingCard(
    ...
    ElevatedCard(
        ...
        modifier = modifier
            ...
            .animateContentSize() // Animasi agar kartu mekar dengan mulus
            .sharedBoundsWrapper(
        ...
        // KITA BUNGKUS PAKAI COLUMN AGAR AI BISA MUNCUL DI BAWAHNYA
        Column(modifier = Modifier.fillMaxWidth()) {
            
            // --- BAGIAN ATAS: INFO REKAMAN ASLI ---
            Row(
            ...
            // --- BAGIAN TENGAH: TOMBOL AI ---
            if (!isSelectable) { // Sembunyikan tombol AI saat mode pilih banyak
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    FilledTonalButton(
                        onClick = {
                            if (aiSummary.isNullOrEmpty()) onGenerateSummary()
                        ...
                        Text(if (!aiSummary.isNullOrEmpty()) "Lihat Rangkuman" else "Ringkas via AI")
                    }
                }
            }

            // --- BAGIAN BAWAH: TEKS RANGKUMAN AI ---
            AnimatedVisibility(visible = isAiExpanded && !aiSummary.isNullOrEmpty()) {
                Surface(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 16.dp)
